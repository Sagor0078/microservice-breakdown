class ChatSummarizer:
    ...
    def generate_summary(self):
        total_exchanges = min(len(self.parsed_chat["user_messages"]), len(self.parsed_chat["ai_messages"]))
        ...
        summary += f"and the AI responded with {self.analysis['ai_messages']} messages.\n"
